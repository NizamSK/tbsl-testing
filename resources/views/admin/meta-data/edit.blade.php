                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-horizontal" method="POST" action="{{ route('metadata.update',$data['metadata'][0]->id ) }}" >
                                    @csrf
                                    @method('PUT')
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-6">
                                            <select class="form-control" name="route_id"  required>
                                                <option @selected($data['metadata'][0]->route_id) value="1">Select Page</option>
                                                @foreach($data['routes'] as $route)
                                                    <option @selected($data['metadata'][0]->route_id == $route->id) value="{{ $route->id }}">{{ $route->name }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-6">
                                            <input type="text" class="form-control" value="{{ $data['metadata'][0]->meta_title }}" maxlength="80" minlength="4" name="meta_title" required>
                                    ...
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-6">
                                            <input type="text" class="form-control" value="{{ $data['metadata'][0]->meta_keywords }}" maxlength="200" minlength="4" name="meta_keywords" required>
                                    ...
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-6">
                                            <textarea type="number" class="form-control" name="meta_description" maxlength="200" minlength="4" required>{{ $data['metadata'][0]->meta_description }}</textarea>
                                            <small>Max characters allowed is 200</small>
